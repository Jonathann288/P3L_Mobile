...
import 'package:flutter_application_reusemart/entity/TransaksiPenitipanHistory.dart';
                      ...
                      children: [
                          SizedBox(
                            ...
                            child: PageView.builder(
                              itemCount: item.fotoBarang.length,
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  backgroundImage: (item.fotoBarang != null && item.fotoBarang.isNotEmpty)
                      ? NetworkImage('${item.fotoBarang.first}')
                      : null,
                  child: (item.fotoBarang == null || item.fotoBarang.isEmpty)
